...
namespace CBTools_Core {
    ...
    public readonly ref struct ColorRef {
        ...
        /// <param name="x"></param>
        /// <returns></returns>
        public static ColorRef operator ~(ColorRef x) {
            return new ColorRef((byte)(255 - x.r), (byte)(255 - x.g), (byte)(255 - x.b), x.a);
        }

        public bool Equals(ColorRef obj) => this == obj;

        public override int GetHashCode() => throw new InvalidOperationException("Cannot box ref struct");
