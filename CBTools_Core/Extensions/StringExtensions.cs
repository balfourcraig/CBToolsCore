...
namespace CBTools_Core.Extensions
{
    public static class StringExtensions
    {
        ...
        public static string PadBothSides(this string str, in int numberToAddEachSide, char paddingChar = ' ')
        {
            return str.PadLeft(str.Length + numberToAddEachSide, paddingChar).PadRight(str.Length + (numberToAddEachSide * 2), paddingChar);
        }

        public static unsafe string Capitalize(this string s)
        {
            if (s == null)
